...
<div id="bg" class="animateHue">
    <img :src="'/storage/' +currentSong.cover" class="opacity-25 w-full h-full" alt="curentSong.Tittle">
    ...
    <div class="absolute inset-0">
            <div class="flex h-full md:items-center md:mx-auto md:w-3/4">
                <div class="hidden md:flex md:flex-col md:flex-1 md:space-y-3 md:relative md:z-10">
                    ...
                    <button type="button" 
                    class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none 
                    focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition" 
                    @click.prevent="isFormOpen = !isFormOpen">Add new song</button>
